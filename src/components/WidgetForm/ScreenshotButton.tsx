...
export function ScreenshotButton({screenshot, onScreenshotTook}: ScreenshotButtonProps) {
    ...
    async function handleTakeScheenshot() {
        ...
        onScreenshotTook(base64image); // comunicacao com componente pai
    ...
    if (screenshot) {
        return (
            <button
                ...
                className="p-1 w-10 h-10 rounded-md border-transparent flex justify-end items-end text-zinc-400 gover:text-zinc-100 transition-colors"
                style={{
